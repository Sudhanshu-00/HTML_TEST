            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between p-5">
                    <div className="w-full md:w-1/4 mb-6 md:mb-0">
                        <div className="text-lg font-bold mb-2" style={{ backgroundImage: "url('https://www.figma.com/design/iU1hM9XmYbB5KXc8xVX24n/HTML-Test?node-id=1-97&t=cMAGSxYog49laAjp-4')" }}>Logo</div>
                    </div>
                    <div className="w-full md:w-1/4 mb-6 md:mb-0">
                    ...
                    <div className="w-full md:w-1/4 ">
                        <ul>
                            <li className='p-4'>
                                <button className="px-10 py-2 text-sm bg-blue-500 text-white rounded hover:bg-blue-400 space-x-7">Register</button>
                            </li>
                            <li>
                                <button className="px-10 py-2 text-sm p-5 text-blue-600 border bg-white rounded hover:bg-blue-50">Login</button>
                            </li>
                        </ul>
                    </div>
                </div>
