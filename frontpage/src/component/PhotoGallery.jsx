...
const PhotoGallery = () => {
    return (
        <div className="container mx-auto p-4 w-screen">
            ...
            <div className="flex mx-2 md:w-1/2 p-4 ">
                <div className="w-1/3 px-2 border-2">
                    ...
                    <p className="text-center">Sed ut perspiciatis</p>
                </div>
                ...
                <div className="w-1/3 px-2">
                    ...
                    <p className="text-center">Nemo enim ipsam</p>
                </div>
            </div>
        </div>
    );
